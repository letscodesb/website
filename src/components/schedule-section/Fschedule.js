...
export default withTranslation()(
    class MWScheduleSection extends Component {
        ...
        render() {
            ...
            let schedule = [
                { name: t('log-in'), time: "8:45", long: true },
                { name: t('presentation'), time: "9:00", long: true },
                { name: t('q/a'), time: "9:30", long: true },
                { name: t('day-ends'), time: "11:00", long: true },
            ];
            ...
            return (
                ...
                >
                    <div id="schedule-section-header">
                        <h1 id="schedule-section-header-text">{t('Fschedule-header')}</h1>
                    </div>
