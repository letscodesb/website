    ...
    class MWScheduleSection extends Component {
        ...
        render() {
            ...
            let schedule = [
                ...
                { name: t('introduce-project'), time: "9:00", long: true },
                { name: t('final-project'), time: "9:30", long: true },
                { name: t('lunch'), time: "12:00", long: false },
                { name: t('final-project'), time: "1:00", long: true },
            ...
            return (
                ...
                >
                    <div id="schedule-section-header">
                        <h1 id="schedule-section-header-text">{t('THschedule-header')}</h1>
                    </div>
